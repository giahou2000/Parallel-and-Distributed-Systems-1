...
*   and copies it to stdout. This program does nothing useful, but
...
int main(int argc, char *argv[])
{
    ...
    if (argc < 2)
	{
        // if no filename is provided, print usage message and exit
		fprintf(stderr, "Usage: %s [martix-market-filename]\n", argv[0]);
		exit(1);
	}
    else    
    {
        // if a filename is provided, attempt to open the file for reading
    ...
    {
        // if the banner cannot be read, print an error message and exit
